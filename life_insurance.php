...
<body>
    ...
    <!-- header-end -->
      ...
      <!-- bradcam_area  -->
      <div class="bradcam_area bradcam_bg_life_insurance">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <form style="padding-top: 20px;" class="form-contact contact_form" method="POST" action="./life_insurance.php">
                        <div class="form"  >
                            <div class="row">
                                <div class="col-sm-4">
    ...
    <div class="life-sinsurance extra_padding">
        <div class="container">
            <div class="row justify-content-end">
                <div class="col-lg-6">
                    <div class="faq_ask pl-68">
                        <h3 class="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s">How Life Insurance Works?</h3>
                            <div id="accordion">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section_title text-center mb-90">
                        ...
                        <h3 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">The advantages of life insurance</h3>
                        <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">There are plenty of benefits of buying life insurance, here are the three most common:
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div style="text-align: center;" class="single_works wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                        ...
                        <h3>Life insurance gives you inner peace</h3>
                        <p>A good life comes with some worries, especially if you have kids and/or a partner, and a life insurance policy can give you tremendous tranquility, knowing that there is a financial backup plan for your dependents. </p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div style="text-align: center;"  class="single_works wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                        ...
                        <h3>usually tax-free</h3>
                        <p>In the event that you die during your life insurance term, payouts to your beneficiaries are typically tax-free. Not only does this mean your money goes straight to them, but it also means you can do less math..</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div style="text-align: center;"  class="single_works wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">
                        ...
                        <p>The sense of calm you feel when you know you’ve protected your family with life insurance will also be felt by your family themselves.</p>
                    </div>
                </div>
            </div>
        </div>
