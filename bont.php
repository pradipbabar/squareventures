...
<body>
    ...
    <!-- header-end -->
      ...
      <!-- bradcam_area  -->
      <div class="bradcam_area bradcam_bg_fixeddepo">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <form style="padding-top: 20px;" class="form-contact contact_form" method="POST" action="./bont.php">
                        <div class="form"  >
                            <div class="row">
                                <div class="col-sm-4">
    ...
    <div class=" bond extra_padding">
        <div class="container">
            <div class="row justify-content-end">
                <div class="col-lg-6">
                    <div class="faq_ask pl-68">
                        <h3 class="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s"> Ways to Invest in Bonds?</h3>
                            <div id="accordion">
                                <div class="card wow fadeInUp" data-wow-duration="1.1s" data-wow-delay=".3s">
                                  ...
                                  <div class="card wow fadeInUp" data-wow-duration="1.1s" data-wow-delay=".3s">
                                    ...
                                    <div id="collapseOnee" class="collapse show" aria-labelledby="headingOnee" data-parent="#accordion">
                                      <div class="card-body">
                                        Bonds and other fixed-income securities play a critical role in an investor's portfolio. Owning bonds helps to diversify a portfolio, as the bond market doesn't rise or fall alongside the stock market.
                                      </div>
                                    </div>
                                  </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section_title text-center mb-90">
                        ...
                        <h3 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">What Are The Benefits Of bond?</h3>
                        <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">Bonds are as important to an investment portfolio today as ever. 
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div style="text-align: center;" class="single_works wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                        ...
                        <h3>Bonds Provide Income</h3>
                        <p>While many investments provide some form of income, bonds tend to offer the highest and most reliable cash streams.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div style="text-align: center;"  class="single_works wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                        ...
                        <h3>Bonds Offer Diversification</h3>
                        <p>Over time, greater diversification can provide investors with better risk-adjusted returns  than portfolios with a narrower focus.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div style="text-align: center;"  class="single_works wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">
                        ...
                        <h3>Bonds Preserve Principal</h3>
                        <p>Fixed income investments are very useful for people nearing the point where they will need to use the cash they have invested – for instance, an investor within five years of retirement or a parent whose child is starting college.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-2 borderfooter col-md-6 col-lg-3">
                    <div class="footer_widget wow fadeInUp" data-wow-duration="1.1s" data-wow-delay=".4s">
                        ...
                        <ul>
                            ...
                            <li><a href="./demate_account.html">HEALTH-INSURANCE</a></li>
                        </ul>
