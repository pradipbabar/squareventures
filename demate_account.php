...
<body>
    ...
    <!-- header-end -->
      ...
      <!-- bradcam_area  -->
      <div class="bradcam_area bradcam_bg_account">
        <div class="container">
            <div class="row">
                
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3>Demat & trading account</h3>                      
                    </div>
                    <form style="padding-top: 20px;" class="form-contact contact_form" method="POST" action="./demate_account.php">
                        <div class="form"  >
                            <div class="row">
                                <div class="col-sm-4">
    ...
    <div class="demate_account  extra_padding">
        <div class="container">
            <div class="row justify-content-end">
                <div class="col-lg-6">
                    <div class="faq_ask pl-68">
                        <h3 class="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s"> What is  demat account ?</h3>
                            <div id="accordion">
                                <div class="card wow fadeInUp" data-wow-duration="1.1s" data-wow-delay=".3s">
                                  ...
                                  <div class="card wow fadeInUp" data-wow-duration="1.1s" data-wow-delay=".3s">
                                    ...
                                    <div id="collapseOnee" class="collapse show" aria-labelledby="headingOnee" data-parent="#accordion">
                                      <div class="card-body">
                                        India adopted the Demat account for electronic storing, wherein shares and securities are represented and maintained electronically, thus eliminating the troubles associated with paper shares
                                      </div>
                                    </div>
                                  </div>
                                  <div class="card wow fadeInUp" data-wow-duration="1.1s" data-wow-delay=".3s">
                                    ...
                                    <div id="collapseOnee" class="collapse show" aria-labelledby="headingOnee" data-parent="#accordion">
                                      <div class="card-body">
                                        A Fixed Deposit offers guaranteed returns. Unlike market-led investments where returns fluctuate over time, the returns on an FD are fixed when you open the account.
                                      </div>
                                    </div>
                                  </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section_title text-center mb-90">
                        ...
                        <h3 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">Benefits of Demat system</h3>
                        <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">Demat account for shares and securities with business purpose. 
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div style="text-align: center;" class="single_works wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                        ...
                        <h3>Benefit to the company</h3>
                        <p>The depository system helps in reducing the cost of new issues due to lower printing and distribution costs. It provides better facilities for communication and timely service to shareholders and investors.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div style="text-align: center;"  class="single_works wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                        ...
                        <h3>Benefit to the investor</h3>
                        <p>
                            The depository system reduces risks involved in holding physical certificates, e.g., loss, theft, mutilation, forgery, etc.  It ensures transfer settlements and reduces delay in registration of shares. </p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div style="text-align: center;"  class="single_works wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">
                        ...
                        <h3>Benefits to brokers
                        </h3>
                        <p>It reduces risks of delayed settlement. It ensures greater profit due to increase in volume of trading. It eliminates chances of forgery or bad delivery. </p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-8 col-md-7">
                <div class="loan_text wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s">
                    <h3>Choose a tenure and amount of your choice to grow your income in a steady fashion.
                        </h3>
                </div>
            </div>
                ...
                <div class="col-xl-2 borderfooter col-md-6 col-lg-3">
                    <div class="footer_widget wow fadeInUp" data-wow-duration="1.1s" data-wow-delay=".4s">
                        ...
                        <ul>
                            ...
                            <li><a href="./fixed_deposit.html">FIXED DIPOSIT </a></li>
