...
<body>
    ...
    <!-- header-end -->
      ...
      <!-- bradcam_area  -->
      <div class="bradcam_area bradcam_bg_health">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-12">
                    ...
                    <form style="padding-top: 20px;" class="form-contact contact_form" method="POST" action="./health_insurance.php">
                        <div class="form"  >
                            <div class="row">
                                <div class="col-sm-4">
    ...
    <div class="health-insurance  extra_padding">
        <div class="container">
            <div class="row justify-content-end">
                <div class="col-lg-6">
                    <div class="faq_ask pl-68">
                        <h3 class="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s"> Health Insurance</h3>
                            <div id="accordion">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section_title text-center mb-90">
                        ...
                        <h3 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">Benefits of Healt Insurance</h3>
                        <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s"> How it protects you from health and financial risks. 
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div style="text-align: center;" class="single_works wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                        ...
                        <h3>Protects savings</h3>
                        <p>Opting for a Health Insurance policy protects your savings from getting depleted for medical treatments. Medical emergencies are unpredictable, and with rising medical costs, quality treatment can get very expensive. </p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div style="text-align: center;"  class="single_works wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                        ...
                        <p>
                            Most insurance policies have a cashless treatment, where the insurance company directly settles bills with the hospital. In such types of policies, there is a network of hospitals where the insured can get treated. </p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div style="text-align: center;"  class="single_works wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">
                        ...
                        <h3>Provides coverage for the family
                        </h3>
                        <p>Buying individual Health Insurance policies can get expensive. But most insurance companies provide family floater plans where policies and their benefits are clubbed together. </p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-2 borderfooter col-md-6 col-lg-3">
                    <div class="footer_widget wow fadeInUp" data-wow-duration="1.1s" data-wow-delay=".4s">
                        ...
                        <ul>
                            ...
                            <li><a href="./fixed_deposit.html">FIXED DEPOSIT
                            </a></li>
