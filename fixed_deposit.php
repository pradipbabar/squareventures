...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <form style="padding-top: 20px;" class="form-contact contact_form" method="POST" action="./fixed_deposit.php">
                        <div class="form"  >
                            <div class="row">
                                <div class="col-sm-4">
    ...
    <div class=" fixed-deposit extra_padding">
        <div class="container">
            <div class="row justify-content-end">
                <div class="col-lg-6">
                    <div class="faq_ask pl-68">
                        <h3 class="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s"> What is  Fixed deposit?</h3>
                            <div id="accordion">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section_title text-center mb-90">
                        ...
                        <h3 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">What Are The Benefits Of A Fixed Deposit (FD)?</h3>
                        <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">For Indians, investing in a fixed deposit has always been one of the preferred choices. 
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div style="text-align: center;" class="single_works wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                        ...
                        <h3>Fixed returns</h3>
                        <p>A fixed deposit offers guaranteed returns. The rate of interest offered to you when you open an FD remains constant throughout your tenure.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div style="text-align: center;"  class="single_works wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                        ...
                        <p>If you wish to get a regular income, you can opt for monthly or quarterly interest pay-outs.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div style="text-align: center;"  class="single_works wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">
                        ...
                        <p>If you have a savings account, you can open a FD in just a few clicks or by visiting the nearest branch. Once you open it, you don’t have to worry about it till it matures.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-2 borderfooter col-md-6 col-lg-3">
                    <div class="footer_widget wow fadeInUp" data-wow-duration="1.1s" data-wow-delay=".4s">
                        ...
                        <ul>
                            ...
                            <li><a href="./demate_account.html">
                                DEMAT & TRADING ACCOUNT</a></li>
                        </ul>
